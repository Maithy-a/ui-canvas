...
const UserCard = ({ firstName, lastName, verified, bio, rate, earned, rating, imageUrl }: UserCardProps) => {
    return (
        <div className="bg-white p-2 border shadow-md rounded-3xl w-[300]" >
            <div className="relative">
                ...
                />
                <div className="absolute top-2 right-2 p-2 rounded-full cursor-pointer
